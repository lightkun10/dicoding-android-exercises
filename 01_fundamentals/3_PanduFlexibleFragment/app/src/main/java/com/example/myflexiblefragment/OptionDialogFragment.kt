...
class OptionDialogFragment : DialogFragment(), View.OnClickListener {
    /* Sama dengan obyek fragment seperti sebelumnya, di sini kelas
       fragment yang dibuat inherit ke DialogFragment. */
                ...
                if (checkedRadioButtonId != -1) {
                    ...
                    if (optionDialogListener != null) {
                        ...
                        /* Menggunakan interface
                           Ketika pengguna menekan tombol Pilih setelah memilih
                           salah satu pilihan dihalaman detail category,
